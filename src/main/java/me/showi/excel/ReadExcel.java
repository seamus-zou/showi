...
//					return readXls(path);
	...
	/**
	 * 56 * Read the Excel 2010 57 * @param path the path of the excel file 58 * @return 59 * @throws IOException 60
	 */
...
//					student = new Student();
					...
					temp.add(getValue(cell1));
					temp.add(getValue(cell2));
					temp.add(getValue(cell3));
					temp.add(getValue(cell4));
					temp.add(getValue(cell5));
